...
/**  plist = NULL 
*/
void test_papersListIntoTable1_given_plist_is_NULL_should_create_session_with_nothing(void){
  pList = NULL;
  //-------------------------------------------------------------------------------------------

  papersListIntoTable1( &table, pList, 50);
  TEST_ASSERT_NULL(S1);
  ////printfTable( table);
}
...
/**  plist = p1,p2,p3,p4
  ...
  * 
*/
void test_papersListIntoTable1_given_populatoin_is_50_should_create_4_session(void){
...
/**  plist = p1,p2,p3,p4
  ...
  * 
*/
void test_papersListIntoTable1_given_populatoin_is_75_should_create_4_session(void){
  pList = linkListNew(&p4);
  addDataToHead(&pList, &p3);
  addDataToHead(&pList, &p2);
  addDataToHead(&pList, &p1); 
...
/**  plist = p1,p2,p3,p4
  ...
  * 
*/
void test_papersListIntoTable1_given_populatoin_is_100_should_create_2_session(void){
  pList = linkListNew(&p4);
  addDataToHead(&pList, &p3);
  addDataToHead(&pList, &p2);
  addDataToHead(&pList, &p1); 
  ...
  papersListIntoTable1( &table, pList, 100);
  //printfTable( table);
  TEST_ASSERT_NOT_NULL(S1);
  TEST_ASSERT_NOT_NULL(S2);
  TEST_ASSERT_NULL(S3);
...
/**  plist = p1,p2,p3,p4,p5,p6,p7,p8,p9
  ...
  * 
*/
void test_papersListIntoTable1_given_9paper_populatoin_is_150_should_create_3_session(void){
  ...
  papersListIntoTable1( &table, pList, 150);
  //printfTable( table);
  TEST_ASSERT_NOT_NULL(S1);
  TEST_ASSERT_NOT_NULL(S2);
  TEST_ASSERT_NOT_NULL(S3);
...
/**  plist = p1,p2,p3,p4,p5,p6,p7,p8,p9
  ...
  * 
*/
void test_papersListIntoTable1_given_9paper_populatoin_is_200_should_create_3_session(void){
  pList = linkListNew(&p9);
  addDataToHead(&pList, &p8);
  addDataToHead(&pList, &p7);
  addDataToHead(&pList, &p6); 
  ...
  papersListIntoTable1( &table, pList, 200);
  //printfTable( table);
  TEST_ASSERT_NOT_NULL(S1);
  TEST_ASSERT_NOT_NULL(S2);
  TEST_ASSERT_NOT_NULL(S3);
...
/**  plist = p1,p2,p3,p4,p5,p6,p7,p8,p9
  ...
  * 
*/
void test_papersListIntoTable1_given_9paper_populatoin_is_300_should_create_2_session(void){
  pList = linkListNew(&p9);
  addDataToHead(&pList, &p8);
  addDataToHead(&pList, &p7);
  addDataToHead(&pList, &p6); 
  ...
  papersListIntoTable1( &table, pList, 300);
  //printfTable( table);
  TEST_ASSERT_NOT_NULL(S1);
  TEST_ASSERT_NOT_NULL(S2);
  TEST_ASSERT_NULL(S3);
...
/**  plist = p1,p2,p3,p4,p5,p6,p7,p8,p9
  ...
  * 
*/
void test_papersListIntoTable1_given_9paper_populatoin_is_600_should_create_1_session(void){
  pList = linkListNew(&p9);
  addDataToHead(&pList, &p8);
  addDataToHead(&pList, &p7);
  addDataToHead(&pList, &p6); 
  ...
  papersListIntoTable1( &table, pList, 600);
  //printfTable( table);
  TEST_ASSERT_NOT_NULL(S1);
  TEST_ASSERT_NULL(S2);
  TEST_ASSERT_EQUAL_PTR(&p1, S1_1->data);
...
*/
void xtest_papersListIntoTable1_given_populatoin_is_25_should_system_fail_due_to_assertion(void){
  ...
  papersListIntoTable1( &table, pList, 25);
}